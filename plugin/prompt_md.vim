...
autocmd BufReadPost *.prompt.md call prompt_md#remember_last_prompt_file()
...
command! PromptMdSendAtThisPathWithHashLine call prompt_md#send_at_this_path_with_hash_line()
command! PromptMdSendWord call prompt_md#send_word()
command! PromptMdSendSelection -range=% call prompt_md#send_selection()
...
command! PromptMdSendAtThisPathWithHashLineAndOpenPrompt call prompt_md#send_at_this_path_with_hash_line_and_open_prompt()
command! PromptMdSendWordAndOpenPrompt call prompt_md#send_word_and_open_prompt()
command! PromptMdSendSelectionAndOpenPrompt -range=% call prompt_md#send_selection_and_open_prompt()
